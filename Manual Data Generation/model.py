...
features_train = data.iloc[:-40, 0:3]
labels_train = data.iloc[:-40, 3:]
features_test = data.iloc[-40:, 0:3]
labels_test = data.iloc[-40:, 3:]
# features_train, features_test, labels_train, labels_test = train_test_split(features, labels, test_size = 0.25)

model = create_model()
history = fit_model(model, features_train, labels_train, 1000, 50)
