...
model = create_model()
history = fit_model(model, features_train, labels_train, 3000, 750)
plot(history, "forward_kinematics_network/given_model/given_model_history.png")
val_mse, val_mae = model.evaluate(features_test, labels_test, verbose = 0)
print(val_mse, val_mae)

model.save("forward_kinematics_network/given_model/given_network")